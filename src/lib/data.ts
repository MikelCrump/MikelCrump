...
export const events: PlatformEvent[] = [
  ...
  },
  {
    ...
    subtitle: "A one-day intensive for live session leaders.",
    description:
      "Practice holding rooms when energy dips, agendas slip, and stakeholders push. You'll run three live scenarios with coaching between rounds — no slides marathon.",
    cover:
  ...
  },
  {
    ...
    description:
      "Seven learners, one coastal house, deep work blocks and evening critique. Bring one course or event series you need to finish. We protect the calendar so you can.",
    cover:
